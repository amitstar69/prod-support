...
const DeveloperCompletionStep: React.FC = () => {
  ...
  return (
    <OnboardingLayout
      ...
      subtitle="You're all set to start helping clients with their projects"
      ...
      <div className="flex flex-col items-center justify-center py-8 space-y-6">
        ...
        <div className="space-y-2 text-center">
          ...
          <p className="text-muted-foreground">
            You've successfully completed all the required steps to set up your developer profile.
            You're now ready to start receiving help requests from clients.
          </p>
        </div>
