        ...
        {ticket?.status && (
          <span className={`
            ...
            ${
              ...
              ticket.status === 'ready_for_client_qa' ? 'bg-indigo-50 text-indigo-800 border-indigo-200' :
              ticket.status === 'qa_fail' ? 'bg-orange-50 text-orange-800 border-orange-200' :
              ticket.status === 'qa_pass' ? 'bg-emerald-50 text-emerald-800 border-emerald-200' :
              ticket.status === 'resolved' ? 'bg-slate-50 text-slate-800 border-slate-200' :
